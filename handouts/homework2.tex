...
The whole scene is contained in a \lstlisting{scene} tag. 
...
You do not need to worry about area lights yet (we will implement it in homework 3).
You do not need to worry about \lstinline{normals} and \lstinline{uvs} in \lstinline{ParsedTriangleMesh} (we will use them in homework 3).
You do not need to worry about \lstinline{ParsedImageTexture} (we will use it in homework 3).
...
We also provided a few new ones that can contains triangle meshes.
