...
\int_{\omega \in \Omega} \frac{K_d \cdot \max\left(n_s \cdot l, 0\right)}{\pi} \cdot L \cdot \mathrm{d}\omega.
...
\begin{equation}
L = \int_{\omega \in \Omega} \frac{K_d \cdot \max\left(n_s \cdot l, 0\right)}{\pi} \cdot L \cdot \mathrm{d}\omega.
\end{equation}
This is however vacuous, because there is no \emph{base case} for this recursion. We will instead add the emission whenever we hit a light source:
\begin{equation}
L = L_e + \int_{\omega \in \Omega} \frac{K_d \cdot \max\left(n_s \cdot l, 0\right)}{\pi} \cdot L \cdot \mathrm{d}\omega.
\end{equation}
