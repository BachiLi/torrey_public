...
Finally, we can do something similar to \lstinline{plastic} to combine a diffuse component and $\rho_{\text{phong-specular}}$:
\begin{equation}
\rho_{\text{phong}} = \frac{K_d}{\pi} \max\left(n_s \cdot \omega, 0\right) + \rho_{\text{phong-specular}}.
\label{eq:phong}
\end{equation}
...
Now, add the Phong BRDF (Equation~\eqref{eq:phong}) into your \lstinline{hw_4_2} code.
