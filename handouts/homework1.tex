...
\paragraph{Front facing vs back facing normals.} Read \href{https://raytracing.github.io/books/RayTracingInOneWeekend.html#surfacenormalsandmultipleobjects/frontfacesversusbackfaces}{Chapter 6.4} of RTOW and have an understanding of the difference between front facing and back facing normals. In our rendering system, we assign two different materials to the front facing part of the surface and the back facing part. If your ray hit the front facing part, use \lstinline{diffuse_color}. On the other hand, if it hits the back facing part, use \lstinline{back_diffuse_color}.
